...
<script>
    ...
    export default {
        ...
        created() {
            ...
            svgColor() { return this.connection.connectionState == 'Connected' ? 'green' : 'red' }
        }
    }
</script>